...
model = BESS(time_step, BESS.create_action_set(-5000, 5000, n_actions), 13.5 * 1000 * 60 * 60, 0.95, 0.95, 0, correct_infeasible=allow_infeasible_actions)
...
output_location = '{}/output/{{}}_bess_state'.format(os.path.dirname(__file__)) 