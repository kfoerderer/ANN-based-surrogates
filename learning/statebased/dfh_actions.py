...
# simulation
from .dfh_state import time_step, model, state_matrix, hwt_min_temp, hwt_max_temp
...
input_processor.discretize([0]) # demand -> eliminate
...
output_location = '{}/output/{{}}_dfh_actions'.format(os.path.dirname(__file__)) 
