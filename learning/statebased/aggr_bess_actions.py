...
# simulation
from .aggr_bess_state import time_step, n_actions, model
...
input_processor.normalize([0]*len(model.capacities), model.capacities) # soc
...
output_location = '{}/output/{{}}_aggr_bess_actions'.format(os.path.dirname(__file__)) 